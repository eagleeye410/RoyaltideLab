 ...
 * This file demonstrates how to integrate Royaltide with a web frontend
 */

// For React/Vue/Angular applications
export class RoyaltideClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new RoyaltideClient(provider, contractAddress);
